...
{{--                                <span class="badge badge-info right">6</span>--}}
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('product_cat.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Product Category</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('product_info.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Product</p>
                                </a>
                            </li>
...
{{--                    @yield('content')--}}
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-2019 <a href="http://adminlte.io">shop</a>.</strong>
        All rights reserved.
